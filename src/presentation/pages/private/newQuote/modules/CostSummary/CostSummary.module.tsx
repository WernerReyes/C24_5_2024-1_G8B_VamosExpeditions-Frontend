...
export const CostSummaryModule = () => {
  const { daysNumber } = useQuotationStore();
  ...
  return (
    <div className="p-6 w-full bg-gray-100">
      <TabView
        ...
        tabPanelContent={Array.from({ length: daysNumber }).map((_, index) => ({
          header: `Día ${index + 1}`,
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <div>
                                    <h2 className="text-xl font-semibold">
                                      {
                                        quote.accommodationRoom.accommodation
                                          .name
                                      }{" "}
                                      - {quote.accommodationRoom.roomType}
                                    </h2>
