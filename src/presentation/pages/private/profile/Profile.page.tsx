...
import { Avatar, Badge, Button, Card, Divider, Tag } from "@/presentation/components";
...
export const ProfilePage = () => {
  ...
  return (
    <>
    <EditModalProfile showModal={isEditModalOpen} setShowModal={setIsEditModalOpen} />
      ...
      <Card className="w-full shadow-lg p-4">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="w-full md:w-1/3 flex flex-col justify-center items-center  text-center">
            ...
            >
              <Badge className="w-6 h-6 mt-2 me-4" severity="success" />
            </Avatar>
          ...
          <div className="w-full md:w-2/3">
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              ...
              <p>
                <label className="block text-slate-400">Phone:</label> +1 (555)
                123-4567
              </p>
            </div>
            ...
            <p className="mt-4 text-gray-600">
              John is a senior administrator with full system access. He manages
              the IT department and oversees all technical operations.
            </p>
          </div>
        </div>
      </Card>
