...
import { FilterApplyButton, FilterByDate, FilterClearButton } from "../filters";
import { UserDevices } from "./components/UserDevices";
import { FilterByStatus } from "./filters";
import { UserTableFilters } from "./types/UserTableFilters";
import { filterByStatus, getTransformedFilters } from "./utils/filters";
...
const UsersPage = () => {
  ...
  const header = (
    <div className="flex sm:justify-between gap-y-3 flex-wrap justify-center items-center">
      ...
      <Button icon="pi pi-trash" label="Papelera" outlined size="small" />
    </div>
  );
